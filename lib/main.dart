...
class CombinedShapesPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(
      Rect.fromCenter(
          center: Offset(centerX, centerY + 40), width: 80, height: 80),
      housePaint,
    );
    ...
    canvas.drawRect(
      Rect.fromCenter(
          center: Offset(centerX, centerY + 60), width: 30, height: 50),
      doorPaint,
    );
    ...
    canvas.drawRect(
      Rect.fromCenter(
          center: Offset(centerX - 25, centerY + 20), width: 20, height: 20),
      windowPaint,
    );
    canvas.drawRect(
      Rect.fromCenter(
...
class StyledShapesPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final rect = Rect.fromCenter(
        center: Offset(centerX, centerY - 100), width: 200, height: 60);
    canvas.drawRect(
      rect,
      Paint()
    ...
    canvas.drawOval(
      Rect.fromCenter(
          center: Offset(centerX + 80, centerY), width: 100, height: 60),
      ovalPaint,
    );
    ...
    final arcRect = Rect.fromCenter(
        center: Offset(centerX, centerY + 100), width: 120, height: 120);
    final arcPaint = Paint()
    ...
    canvas.drawArc(
      Rect.fromCenter(
          center: Offset(centerX, centerY + 100), width: 100, height: 100),
      0, // start angle
      2.5, // sweep angle
      false,
      arcPaint,
